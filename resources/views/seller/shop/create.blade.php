    ...
    <div class="max-w-4xl mx-auto">
        <div
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Create Your Shop</h1>
            </div>
            <div class="p-6">
                <p class="text-gray-600 dark:text-gray-400 mb-6">Please fill in the details below to create your shop. This
                    information will be visible to customers.</p>
