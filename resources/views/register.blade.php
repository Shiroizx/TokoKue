...
<head>
    ...
    <title>Register - Toko Kue Kelompok 2</title>
    <!-- Tailwind CSS -->
...
<body>
    <div class="register-card" data-aos="zoom-in" data-aos-duration="800">
        ...
        <div class="register-form" data-aos="fade-right" data-aos-delay="300">
            <h2 class="text-xl font-bold mb-6">Create an account</h2>
            ...
            <!-- Register Form -->
            <form method="POST" action="{{ route('register') }}" data-aos="fade-up" data-aos-delay="600">
                @csrf
                ...
                <div class="checkbox-container mb-5" data-aos="fade-up" data-aos-delay="700">
                    <input type="checkbox" id="terms" name="terms" class="checkbox" required>
                    <label for="terms">I agree to the <a href="#" class="text-blue-400 hover:underline">Terms of Service</a> and <a href="#" class="text-blue-400 hover:underline">Privacy Policy</a></label>
                </div>
        ...
        <div class="brand-content" data-aos="fade-left" data-aos-delay="300">
            ...
            <h1 class="text-2xl font-bold mb-3" data-aos="fade-up" data-aos-delay="400">Join Our Sweet Community</h1>
            <p class="mb-4 text-sm" data-aos="fade-up" data-aos-delay="500">
                Bergabunglah dengan ribuan pecinta kue di Toko Kue Kelompok 2. Dapatkan akses eksklusif ke koleksi kue premium kami dan penawaran spesial.
            </p>

            <div class="role-badges" data-aos="fade-up" data-aos-delay="600">
            ...
            <div class="mt-8" data-aos="fade-up" data-aos-delay="700">
                <h3 class="font-semibold mb-3">Why Join Us?</h3>
                <ul class="space-y-2 text-sm">
                    <li class="flex items-center" data-aos="fade-up" data-aos-delay="800">
                        <i class="fas fa-check mr-2 text-green-400"></i>
                        <span>Premium Cake Selection</span>
                    </li>
                    <li class="flex items-center" data-aos="fade-up" data-aos-delay="900">
                        <i class="fas fa-check mr-2 text-green-400"></i>
                        <span>Exclusive Member Offers</span>
                    </li>
                    <li class="flex items-center" data-aos="fade-up" data-aos-delay="1000">
                        <i class="fas fa-check mr-2 text-green-400"></i>
                        <span>Quick & Secure Checkout</span>
                    </li>
                    <li class="flex items-center" data-aos="fade-up" data-aos-delay="1100">
                        <i class="fas fa-check mr-2 text-green-400"></i>
