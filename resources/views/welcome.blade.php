                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            ...
                            <p class="italic text-gray-600">"Kue yang saya pesan untuk acara ulang tahun anak saya sangat lezat dan cantik! Semua tamu memuji tampilannya dan rasanya yang pas. Terima kasih Sweet Cake!"</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            ...
                            <p class="italic text-gray-600">"Saya sudah mencoba banyak toko kue, tapi Sweet Cake adalah yang terbaik. Kuenya lembut, tidak terlalu manis, dan selalu datang tepat waktu. Pelayanannya juga sangat ramah!"</p>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    <h4 class="font-bold">Diana Permata</h4>
                                    <div class="flex text-amber-400 text-sm">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
